                            ...
                            if (this.props.location.pathname === "/index-developer") {
                                        ...
                                        <li className="list-inline-item mb-0 pe-1">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        className="media align-items-center justify-content-between pt-4 border-top">
                                ...
                                return (
                                    <ul className="buy-button list-inline mb-0">
                                        ...
                                        <li className="list-inline-item mb-0">
                                            <Link to="#" className="btn btn-icon btn-primary me-1"><i
                                                className="uil uil-facebook-f icons"></i></Link>
                                        </li>
                                        <li className="list-inline-item mb-0">
                                            <Link to="#" className="btn btn-icon btn-primary me-1"><i
                                                className="uil uil-github icons"></i></Link>
                                        </li>
                                        <li className="list-inline-item mb-0">
                                            <Link to="#" className="btn btn-icon btn-primary me-1"><i
                                                className="uil uil-twitter icons"></i></Link>
                                        </li>
                                        <li className="list-inline-item mb-0">
                                            <Link to="#" className="btn btn-icon btn-primary me-1"><i
                                                className="uil uil-linkedin-alt icons"></i></Link>
                                        </li>
                                    </ul>
                                );
                            } else if (
                                    ...
                                    (loggedIn || !navLink.private) && (
                                        ...
                                        (navLink.child ? (
                                                                        ...
                                                                        item.id < 23 && item.id > 11 ? (
                                                                            <li key={childKey}>
                                                                                <Link to={item.link}>
                                                                                    ...
                                                                                    {item.isNew ? (
                                                                                        <span
                                                                                            className="badge bg-danger rounded ms-2">
                                          new
                                        </span>
                                                                                    ) : null}
                                                                                </Link>
                                          ...
                                          new
                                                                                    ...
                                                                                    {item.isOnePage ? (
                                                                                        <span
                                                                                            className="badge bg-warning rounded ms-2">
                                          Onepage
                                        </span>
                                                                                    ) : null}
                                                                                    {item.isupdatePage ? (
                                                                                        <span
                                                                                            className="badge badge-pill bg-info">
                                          Updated
                                        </span>
                                                                                    ) : null}
                                                                                </Link>
