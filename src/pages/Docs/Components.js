                    ...
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        <h6 className="text-muted mb-2 pb-2">
                          Ex.{" "}
                          <code className="text-danger">
                            &lt;div className="bg-primary"&gt; Sutura Saas &
                    ...
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        <h6 className="text-muted mb-2 pb-2">
                          Ex.{" "}
                          <code className="text-danger">
                            &lt;div className="bg-soft-primary"&gt; Sutura
                    ...
                    <div className="component-wrapper rounded shadow">
                      ...
                      <div className="p-4">
                        <h6 className="text-muted mb-4 pb-2">
                          Ex.{" "}
                          <code className="text-danger">
                            &lt;div className="text-primary"&gt; Sutura Saas &
                            Software Template &lt;/div&gt;
                          </code>
                        </h6>
                            ...
                            <TabContent activeTab={this.state.activeTab}>
                              <TabPane tabId="1" className="p-3">
                                <p className="text-muted mb-0">
                                  You can combine all the Sutura templates
                              ...
                              <TabPane tabId="2" className="p-3">
                                <p className="text-muted mb-0">
                                  Can combine all the Sutura templates into a
