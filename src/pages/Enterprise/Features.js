            ...
            <Row className="align-items-center">
              ...
              >
                <div className="section-title">
                  <SectionTitleLeft
                    desc="Using Sutura to build your site means never worrying about designing another page or cross browser compatibility. Our ever-growing library of components and pre-designed layouts will make your life easier."
