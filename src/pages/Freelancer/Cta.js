                        ...
                        <Row className="align-items-center">
                            ...
                            <Col lg={7} md={7} xs={12} className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                                <div className="section-title">
                                    ...
                                    <p className="text-muted para-desc mb-0">Start working with <span className="text-primary fw-bold">Sutura</span> that can provide everything you need to generate awareness, drive traffic, connect.</p>
                                    <div className="my-4">
