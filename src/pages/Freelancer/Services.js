                    ...
                    <Row className="align-items-center">
                        <Col lg={{ size: 5, order: 2 }} xs={{ size: 12, order: 1 }}>
                            <div className="section-title text-center text-lg-start mb-4 mb-lg-0 pb-2 pb-lg-0">
                                ...
                                <p className="text-muted para-desc mx-auto ms-lg-auto mb-0">Start working with <span className="text-primary fw-bold">Sutura</span> that can provide everything you need to generate awareness, drive traffic, connect.</p>
