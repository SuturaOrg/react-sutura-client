                        ...
                        <Row>
                            <Col md="6" xs="12">
                                <div className="d-flex">
                                    ...
                                    <div className="flex-1">
                                        <h5 className="mt-0">How our <span className="text-primary">Sutura</span> work ?</h5>
                            ...
                            <Col md="6" xs="12" className="mt-4 pt-2">
                                <div className="d-flex">
                                    <i><FeatherIcon icon="help-circle" className="fea icon-ex-md text-primary me-2 mt-1" /></i>
                                    <div className="flex-1">
                                        <h5 className="mt-0"> Is <span className="text-primary">Sutura</span> safer to use with my account ?</h5>
                        ...
                        <Row className="my-md-5 pt-md-3 my-4 pt-2 pb-lg-4 justify-content-center">
                            <Col xs={12} className="text-center">
                                <div className="section-title">
                                    ...
                                    <p className="text-muted para-desc mx-auto">Start working with <span className="text-primary fw-bold">Sutura</span> that can provide everything you need to generate awareness, drive traffic, connect.</p>
