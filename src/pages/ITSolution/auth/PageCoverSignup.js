    ...
    handleSubmit(event, values) {
        if (this.state.termsChecked) {
            ...
            if (phoneValue.toString().length == 10) {
                if (phoneValue.toString().startsWith("0")) {
                    values.phone = phoneValue.toString().substring(1);
                } else {
                    dispatch(alertActions.error("Numéro invalide"));
                    return
                }
            }
                                                ...
                                                <CardBody className="p-0">
                                                    ...
                                                    <AvForm className="login-form mt-4"
                                                        ...
                                                        <Row>
                                                            ...
                                                            <Col md={12}>
                                                                <div className="mb-3">
                                                                    <Label className="form-label">Sexe <span
                                                                        className="text-danger">*</span></Label>
                                                                    <div className="form-icon position-relative">
                                                                        <AvField type="select" name="female"
                                                                                 helpMessage="Sélectionnez une catégorie"
                                                            ...
                                                            <Col md={12}>
                                                                <div className="mb-3">
                                                                    <Label className="form-label">Ville de
                                                                        résidence{" "}<span
                                                                            className="text-danger">*</span></Label>
                                                                    <div className="form-icon position-relative">
                                                                        <AvField type="select" name="town" value="town"
                                                                                 helpMessage="Sélectionnez une ville"
                                                                            ...
                                                                            <option value="">- Sélectionnez votre ville
                                                                                -
                                                                            </option>
                                                                            <option value="Agadir">Agadir</option>
                                                                            <option value="Al Hoceïma">Al Hoceïma
                                                                            </option>
                                                                            ...
                                                                            <option value="Errachidia">Errachidia
                                                                            </option>
                                                                            <option value="Essaouira">Essaouira</option>
                                                                            <option value="Fès">Fès</option>
                                                                            <option value="Marrakech">Marrakech</option>
                                                                            <option value="Meknès">Meknès</option>
                                                                            <option value="Mouhammédia">Mouhammédia
                                                                            </option>
                                                                            <option value="Kénitra">Kénitra</option>
                                                                            <option value="Khouribga">Khouribga</option>
                                                                            <option value="Ouarzazate">Ouarzazate
                                                                            </option>
                                                            ...
                                                            <Col md={12}>
                                                                <div className="mb-3">
                                                                    <Label className="form-label">Pays
                                                                        d'origine{" "}<span
                                                                            className="text-danger">*</span></Label>
                                                                    <div className="form-icon position-relative">
                                                                        <AvField type="select" name="country"
                                                                                 helpMessage="Sélectionnez un pays"
                                                                            ...
                                                                            <option value="">- Sélectionnez votre pays
                                                                                -
                                                                            </option>
                                                                            ...
                                                                            <option value="Dominica">Commonwealth
                                                                            </option>
                                                                            ...
                                                                            <option
                                                                                value="Guinea-Bissau">Guinée-Bissau
                                                                            </option>
                                                                            <option value="Equatorial Guinea">Guinée
                                                                                Equatoriale
                                                                            </option>
                                                                            ...
                                                                            <option value="Mauritania">Mauritanie
                                                                            </option>
                                                                            ...
                                                                            <option
                                                                                value="Central African Republic">République
                                                                                Centrafrique
                                                                            </option>
                                                                            <option
                                                                                value="Democratic Republic of the Congo">République
                                                                                Démocratique du Congo
                                                                            </option>
                                                                            <option value="Rwanda">Rwanda</option>
                                                                            <option value="Saint Lucia">Saint Lucie
                                                                            </option>
                                                                            <option
                                                                                value="Sao Tome and Principe">Sao-Tomé
                                                                                et Principe
                                                                            </option>
                                                                            <option value="Senegal">Sénégal</option>
                                                                            <option value="Sierra Leone">Sierra Léone
                                                                            </option>
                                                                            <option value="Singapore">Singapour</option>
                                                                            <option value="Somalia">Somalie</option>
                                                                            <option value="Sudan">Soudan</option>
                                                                            <option value="South sudan">Soudan du Sud
                                                                            </option>
                                                                            <option value="Syrian Arab Republic">Syrie
                                                                            </option>
                                                                            <option
                                                                                value="United Republic of Tanzania">Tanzanie
                                                                            </option>
                                                                            ...
                                                                            <option value="Union of the Comoros">Union
                                                                                des Comores
                                                                            </option>
                                                            ...
                                                            <Col md={12}>
                                                                <div className="mb-3">
                                                                    <Label className="form-label">Année d'entrée au
                                                                        Maroc{" "}<span className="text-danger">*</span></Label>
                                                                    <div className="form-icon position-relative">
                                                                        <AvField type="select" name="yearEntryMorocco"
                                                                                 helpMessage="Sélectionnez une année"
                                                                            ...
                                                                            <option value="">- Sélectionnez une année
                                                                                -
                                                                            </option>
                                                                ...
                                                                <div className="mb-3">
                                                                    ...
                                                                    <AvField
                                                                        ...
                                                                        validate={{
                                                                            required: {
                                                                                value: true,
                                                                                errorMessage: "Veuillez entrer votre filière",
                                                                            },
                                                                        }}
                                                                    />
                                                                </div>
                                                            ...
                                                            <Col md={12}>
                                                                <div className="mb-3">
                                                                    ...
                                                                    <AvField
                                                                        ...
                                                                        required
                                                                        min="0"
                                                                        errorMessage="Numéro invalide. Exemples (06 *** *** ** ou 6 *** *** **)"
                                                                        validate={{
                                                                            required: {
                                                                                value: true,
