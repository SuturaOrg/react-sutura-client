        ...
        <Container className="mt-100 mt-60">
          <Row className="align-items-center">
            <Col lg={5} md={{ size: 6, order: 2 }} xs={{ size: 12, order: 1 }}>
              <img src={social} className="img-fluid" alt="Sutura" />
            </Col>
            ...
            >
              <div className="section-title me-lg-4">
                ...
                <SectionTitleLeft
                  desc="Start working with Sutura that can provide everything you need to generate awareness, drive traffic, connect."
