            ...
            >
              <div className="section-title me-lg-5">
                ...
                <p className="text-muted">
                  You can combine all the Sutura templates into a single one,
                  you can take a component from the Application theme and use it
                  in the Website.
                </p>
              </div>
              <AccordianCommon2
                question1="How our Sutura work ?"
                ...
                <Row className="align-items-center">
                    ...
                    <div className="col-lg-7 col-md-6 mt-4 mt-sm-0 pt-2 pt-sm-0">
                        <div className="section-title ms-lg-4">
                            ...
                            <p className="text-muted">You can combine all the Sutura templates into a single one, you can take a component from the Application theme and use it in the Website.</p>
